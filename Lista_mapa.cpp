...
int main(){
    ...
    for(int t = 0; t < pruebas; t++){
        ...
        if(t==pruebas-1){
            ...
            map<string, int>::iterator it = autor_num.begin(); //Para revisqar los equipos participantes iteramos sobre los elementos del mapa. Para ello, usamos un iterador
